...
export const ZOD_PANEL_LAYOUT_CONFIGURATION_SCHEMA_WITHOUT_ID: ZodType<Omit<PanelLayoutConfiguration, 'id'>> = z.object({
  name: z.string(),
...
export const ZOD_UPDATE_PANEL_LAYOUT_CONFIGURATION_SCHEMA: ZodType<Omit<PanelLayoutConfiguration, 'model' | 'type'>> = z.object({
  id: z.string(),
  name: z.string(),
  inputConfigurations: z.record(z.string(), ZOD_INPUT_CONFIGURATION_SCHEMA),
})
