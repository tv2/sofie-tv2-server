...
export class MongoPanelLayoutConfigurationRepository extends BaseMongoRepository<MongoPanelLayoutConfiguration> implements PanelLayoutConfigurationRepository {
  ...
  public async getPanelLayoutConfigurations(): Promise<PanelLayoutConfiguration[]> {
    ...
    return this.getCollection().find<PanelLayoutConfiguration>({}).toArray()
  }
  ...
  public async updatePanelLayoutConfiguration(panelLayoutConfiguration: PanelLayoutConfiguration): Promise<void> {
    this.assertDatabaseConnection(this.updatePanelLayoutConfiguration.name)
    await this.getCollection().updateOne({ id: panelLayoutConfiguration.id }, { $set: panelLayoutConfiguration })
  }
